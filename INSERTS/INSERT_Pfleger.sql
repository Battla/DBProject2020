...
VALUES('Fabienne', 'Müller', NULL, 'Bergstraße',25, 49778, 'Pflege', 658.87, 1, '1974-12-09', 'FMüller@Krankenhaus.de');
...
INSERT INTO angestellter(Vorname, Nachname, Titel, Strasse, Hausnummer, PLZ, Stellentyp, Gehalt, Station, Geburtsdatum, EMail)
VALUES('Achmed', 'Öztürk', NULL, 'Petersilienstraße',74, 49652, 'Pflege', 2725.15, 1, '1989-10-15', 'AOeztuerk@Krankenhaus.de');
INSERT INTO pfleger(PersonalSSN, Examiniert)
VALUES(LAST_INSERT_ID(),1);
...
INSERT INTO angestellter(Vorname, Nachname, Titel, Strasse, Hausnummer, PLZ, Stellentyp, Gehalt, Station, Geburtsdatum, EMail)
VALUES('Rubia', 'Verkamp', NULL, 'Gänseblümchenstraße',2, 47741, 'Pflege', 2487.46, 2, '2001-07-26', 'RVerkamnp@Krankenhaus.de');
INSERT INTO pfleger(PersonalSSN, Examiniert)
VALUES(LAST_INSERT_ID(),1);
...
INSERT INTO angestellter(Vorname, Nachname, Titel, Strasse, Hausnummer, PLZ, Stellentyp, Gehalt, Station, Geburtsdatum, EMail)
VALUES('Johann', 'Müller', NULL, 'Siebenstein Weg',287, 41125, 'Pflege', 2798.74, 3, '1969-11-14', 'JMueller@Krankenhaus.de');
INSERT INTO pfleger(PersonalSSN, Examiniert)
VALUES(LAST_INSERT_ID(),1);
...
INSERT INTO angestellter(Vorname, Nachname, Titel, Strasse, Hausnummer, PLZ, Stellentyp, Gehalt, Station, Geburtsdatum, EMail)
VALUES('Fatima', 'Celik', NULL, 'Ebereschenweg',274, 49778, 'Pflege', 2445.18, 5, '1987-11-09', 'FCelik@Krankenhaus.de');
INSERT INTO pfleger(PersonalSSN, Examiniert)
VALUES(LAST_INSERT_ID(),1);
